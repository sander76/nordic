                ...
                PvKeypadAlt(
                    ...
                    okay=Commands(
                        ...
                        confirm_command=Confirm(
                            jog_image, confirm_question, yes=confirm_yes
                        ),
                    ),
                ),
                PvKeypadAlt(30, cancel=Commands(navigation_command=cancel_no)),
            ),
        ],
        nav_id=nav_id,
    )
...
left_frontroller = get_direction(
    ...
    confirm_orientation_command=NordicCommands(Nd.ORIENT_BACKROLLER_RIGHT),
...
vb_16mm_type = get_direction(
    ...
    confirm_orientation_command=NordicCommands(
        Nd.RESET, DelayedCommand(Nd.M25S_VENETIAN_16MM, PRODUCT_SET_DELAY)
    ),
    cancel_no=NavigationCommand(1),
...
vvb_left_stack = get_direction(
    ...
    confirm_orientation_command=NordicCommands(
        Nd.RESET,
        DelayedCommand(Nd.M25S_VVB_LEFT_STACK, PRODUCT_SET_DELAY),
...
vvb_right_stack = get_direction(
    ...
    confirm_orientation_command=NordicCommands(
        Nd.RESET,
        DelayedCommand(Nd.M25S_VVB_RIGHT_STACK, PRODUCT_SET_DELAY),
        DelayedCommand(Nd.ORIENT_VVB_LEFT),
    ),
    cancel_no=NavigationCommand(1),
    confirm_yes=NavigationCommand("vvb_start_program"),
...
vvb_split_stack = get_direction(
    ...
    confirm_orientation_command=NordicCommands(
        Nd.RESET,
        DelayedCommand(Nd.M25S_VVB_SPLIT_STACK, PRODUCT_SET_DELAY),
        DelayedCommand(Nd.ORIENT_VVB_LEFT),
    ),
...
vvb_back_right = get_direction(
    ...
    Tr.ORIENT_VVB_BACK,
    NordicCommands(Nd.ORIENT_VVB_RIGHT),
    confirm_yes=NavigationCommand(2),
)
...
tensioned_duette_direction = Step(
    ...
    [
        Row(
            ...
            Text(30, Tr.MOTOR_SHOULD_MOVE_DOWN.add_number(2)),
        ),
        Row(
            PvKeypadAlt(
                30,
    ...
    [
        ...
        Row(
            PvKeypadAlt(
                30,
                okay=Commands(
                    nordic_commands=NordicCommands(Nd.ORIENT_M25S_DUETTE_LEFT),
                    confirm_command=Confirm(
                        DUETTE_JOG_1, Tr.DID_THE_MOTOR_JOG
                    ),
                ),
            ),
