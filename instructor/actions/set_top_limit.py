...
def get_top_limit(jog_image, title=tr.SET_TOP_LIMIT):
    return Step(
        title,
        [
            textrow,
...
def get_top_limit_alternative(title=tr.SET_TOP_LIMIT):
    return Step(
        title,
        [
            Row(
...
def get_confirm_top_limit(jog_image, title=tr.SET_TOP_LIMIT):
    return Step(
        title,
        [
