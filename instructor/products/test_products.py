...
from instructor.actions.general import enter_program_mode, test_blinds, \
    clearshade, test_blinds_open_close_disconnect
from instructor.actions.initialise import initialise_rb
from instructor.actions.motor_direction import left_backroller, \
    right_backroller, left_frontroller, right_frontroller
from instructor.actions.set_bottom_limit import re_set_bottom_limit, set_bottom_limit
...
test_roller = Product(
    ...
    [
        ...
        test_blinds_open_close_disconnect,
        skiptop,
        enter_program_mode,
        set_top_limit_roller,
        skipbottom_end,
